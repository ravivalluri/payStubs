...
export default class InputForm extends Component {
    ...
    getTable(name, payPeriod, grossIncome, incomeTax, netIncome, superAmount) {
        return ( <
            div className = {
                `${inputFormStyles.payslip_card} ${inputFormStyles.payslip}`
            } >
            <
            h1 className = {
                inputFormStyles.salary_slip_header
            } > PayStub < /h1> <
            div className = {
                inputFormStyles.division
            } > < /div> <
            div className = {
                `${inputFormStyles.basic_details} ${appStyles.margin_3} ${appStyles.flex}`
            } >
            <
            table className = {
                inputFormStyles.basic_details_right
            } >
            <
            tbody >
            <
            ...
            <
            td className = {
                `${appStyles.margin_5} ${appStyles.app_font} ${inputFormStyles.width_adjustment_50}`
            } > Name < /td> <
            td className = {
                appStyles.app_font
            } > {
            ...
            <
            table className = {
                inputFormStyles.salary_details
            } >
            <
            tbody >
            <
            ...
            <
            td className = {
                `${appStyles.margin_5} ${appStyles.app_font}`
            } >
            Gross Pay <
            /td> <
            td className = {
    ...
    handleChange(event) {
        if (event.target.id === 'superRate' && event.target.value > 12) {
            this.setState({
                errors: "Taxes should be between 0 to 12"
            });
        } else {
            this.setState({
    ...
    render() {
        return ( <
            div className = {
                inputFormStyles.app_container
            } >
            <
            h3 className = {
                inputFormStyles.error_message
            } > {
                this.state.errors
            } < /h3> <
            ...
            div > <
            div className = {
                appStyles.margin_bottom_10
            } >
            <
            input className = {
                inputFormStyles.generate_button
            }
            type = "submit"
